...
interface IMessagesDialogs {
    ...
    fun showMessageTransaction(title:String,message:String?,setTitlePositiveButton:String,setTitleNegativeButton:String,icon:Int,context: Context,view:View,messageConfirmation:String,messageCancel:String,listener: MessagesDialogsImpl.OnContinueCancelClickListener)
}